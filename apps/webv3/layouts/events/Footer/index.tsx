...
export function LayoutEventsFooter() {
  return (
    <>
      <Container py={64}>
        <Paper
                  ...
                  <SimpleGrid cols={3} py="xl" visibleFrom="lg">
                    ...
                    >
                      <Box>
                        ...
                        <Stack gap="4px">
                          <Anchor href="/" c="gray.0">
                            Classics Home
                          </Anchor>
                          <Anchor href="/events/about" c="gray.0">
                            About Us
                          </Anchor>
                          <Anchor href="/events/events" c="gray.0">
                            Works
                          </Anchor>
                          <Anchor href="/events/contact" c="gray.0">
                            Contact
                          </Anchor>
                        </Stack>
                      </Box>
                    ...
                    >
                      <Box>
                        ...
                        <Stack gap="4px">
                          ...
                          <Anchor c="gray.0">Privacy Policy</Anchor>
                        </Stack>
                      </Box>
                    </motion.div>
                    <motion.div
