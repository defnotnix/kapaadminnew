...
export function _Phase({
  ...
  const { title, images, phaseInfo, phasePhoto } = sectionData;
  ...
  const PhaseShowcase = () => {
    return (
      ...
      >
        ...
        >
          <Image radius="md" src={images[active]} h={600} w="100%" />
          <Center
            h={600}
            w="100%"
            style={{
      ...
      <section className={classes.photo_overlay}>
        <div className={classes.overlay_left}>
          ...
          >
            <Paper withBorder p="2px" pb="md" pos="absolute">
              <Image src={phasePhoto[active][0]} h={300} w={250} />
            </Paper>
          </motion.div>
        </div>
        ...
        <div className={classes.overlay_right}>
          ...
          >
            ...
            >
              <Image src={phasePhoto[active][1]} h={300} w={250} />
            </Paper>
          </motion.div>
        </div>
      </section>
