...
export function ModuleCelebrationsContact({
  sectionData = {
    subheading: "Inquiry",
    heading: ["Ready to get", "the party started?"],
    paragraph: [
      ...
      <Container py={200}>
        <Grid>
          <Grid.Col span={{ base: 12, lg: 4 }}>
            <Stack gap="xl">
              <Text size="sm">Ready to get the party started?</Text>
                  ...
                  <Stack py={"xl"}>
                    ...
                    >
                      <TextInput
                        ...
                        styles={{
                          input: {
                            background: "var(--color-celebrations-primary-50)",
                      ...
                      >
                        <Select
                          ...
                          styles={{
                            input: {
                              background:
                                "var(--color-celebrations-primary-50)",
                              fontSize: "var(--mantine-font-size-xs)",
                            },
                            label: {
                              fontSize: "var(--mantine-font-size-sm)",
