...
export function _Section({ sectionData }: any) {
  ...
  const createImage = async (item: any) => {
    const _data = {
      event: Params?.id,
    };
  };
                ...
                <Stack gap={8}>
                  ...
                  >
                    <Text size={"8px"} c="gray.0" tt="uppercase" w={50}>
                      {phases[active]?.quote1}
                    </Text>

                    <Text size={"8px"} c="gray.0" tt="uppercase" w={50}>
                      {phases[active]?.quote2}
                    </Text>

                    <Text size={"8px"} c="gray.0" tt="uppercase" w={50}>
                      {phases[active]?.quote3}
                    </Text>

                    <Text size={"8px"} c="gray.0" tt="uppercase" w={50}>
                      {phases[active]?.quote4}
                    </Text>
                  </Group>
                ...
                <Text size="xs" ta="center" tt="uppercase" fw={700}>
                  {active == 0
                    ...
                    : active == 1
                      ...
                      : "Post-Event"}
                  <br />
                  {phases[active]?.detailed_tagline}
                </Text>

                <Stack>
                  <Image fit="contain" h={300} src={phases[active]?.image} />
                ...
                <Stack gap="8px">
                  <Group justify="center" gap="xs" px="xl">
                    <Text
                      ...
                      w={"80%"}
                    >
                      {phases[active]?.detailed_services}
                    </Text>
                  </Group>
                </Stack>
              </Paper>
