...
const imgLogo = {
  src: "https://vdocs.classicsprojects.com.np/media/profile/societies.png",
};

const paperElementConfig = {
  radius: 0,
  bg: "var(--color-events-primary-100)",
};

export function ModuleSocieties() {
                ...
                <Grid.Col span={4}>
                  <Paper h={40} {...paperElementConfig}>
                    <Box visibleFrom="lg">
                      ...
                      >
                        <AnimatedText text="THE CLASSICS PROJECTS - EVENTS" />
                      </div>
                    </Box>{" "}
                ...
                <Grid gutter={0}>
                  <Grid.Col span={{ base: 12, lg: 7 }}>
                    <Box visibleFrom="lg">
                      ...
                      >
                        <AnimatedText text="We assist communities," />
                        <AnimatedText text="support societies," />
                        <AnimatedText text="and provide aid in times of need." />
                      </div>
                    </Box>
